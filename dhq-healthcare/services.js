...
const fallbackProviders = [
  { id: "h-1", type: "hospital", name: "Partner Care Hospital", open: true, tags: ["Bed Support Preview", "ICU Desk", "Emergency Alert"] },
  { id: "h-2", type: "hospital", name: "Disha HealthQ Multi Speciality", open: true, tags: ["ICU Preview", "Trauma Desk", "Bed Alerts"] },
  { id: "l-1", type: "lab", name: "Partner Diagnostics Lab", open: true, tags: ["Blood Test", "Home Sample", "Reports"] },
  { id: "l-2", type: "lab", name: "Partner Lab Care", open: true, tags: ["Lab Booking", "CBC", "Thyroid"] },
  { id: "p-1", type: "pharmacy", name: "Partner Pharmacy", open: true, tags: ["Delivery", "Prescription", "24/7"] },
  { id: "b-1", type: "blood", name: "Emergency Blood Donor Network", open: true, tags: ["A+", "O-", "Urgent"] }
];
...
async function loadServices() {
  try {
    const response = await fetch(apiUrl("/api/services"), { credentials: apiCredentials() });
    if (response.ok) {
    ...
    <article class="nearby-provider-card">
      <div class="nearby-provider-head">
        ...
        <div>
          ...
          <small>Location shared after connection</small>
        </div>
...
function requestLocation(isAutomatic) {
  ...
  navigator.geolocation.getCurrentPosition(async (position) => {
    ...
    updateLocationUi("Location permission not allowed. Showing general service previews.", false);
  }, {
